...
<form id="form" action="${__url__}" method="post">
    <table align="center" class="form-table">
		<tr>
			<td>父节点：</td>
			<td>
				<input class="jq-combotree" type="text" id="pid"  name="pid" url="${z:u('department/area_list?ui=combo')}" data-options="{
						required:true,
						method:'post',
		...
		<tr>
			<td>区域名称：</td>
			<td>
				<input name="areaName" class="jq-validatebox" value="" type="text" data-options="required:true">
			</td>
		</tr>
		<tr>
			<td>排序值：</td>
