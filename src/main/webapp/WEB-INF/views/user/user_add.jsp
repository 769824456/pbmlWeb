...
<form id="form" action="${__url__}" method="post">
    <table align="center" class="form-table">
    	<tr>
			<td>用户名：</td>
			<td>
			<input type="text" class="jq-validatebox" name="name"  data-options="required:true"   />           			
			</td>
			<td class="tr">密码：</td>
			<td>
			<input type="password" class="jq-validatebox" name="password"  data-options="required:true"   />           			
			</td>
		</tr>
		<tr>
		 <td>角色：</td>
